function ret = applyBoxFilter(img, pad_size, filter_size, dir_number)
[r, c] = size(img);

box_filter = getBoxFilter(filter_size);

padded_img = padArray(img, pad_size, pad_size);
padded_filter = padArray(box_filter, pad_size, pad_size);
