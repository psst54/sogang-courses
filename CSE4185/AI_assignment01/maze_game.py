...
class Pygame_APP:
    ...
    def drawWall(self, row, col):
        pygame.draw.rect(
            self.displaySurface,
            (40, 80, 80),
            (col * self.blockSizeX, row * self.blockSizeY, self.blockSizeX, self.blockSizeY),
            0,
        )
    ...
    def drawStart(self):
        ...
        pygame.draw.rect(
            ...
            (0, 0, 255),
            (
                col * self.blockSizeX + self.blockSizeX / 4,
                row * self.blockSizeY + self.blockSizeY / 4,
                self.blockSizeX * 0.5,
                self.blockSizeY * 0.5,
            ),
            0,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale", dest="scale", type=int, default=20, help="scale - default: 20")
    parser.add_argument(
        "--speed", dest="speed", type=int, default=15, help="speed for the display - default 15"
    )
    parser.add_argument(
        "--keyboard",
        default=False,
